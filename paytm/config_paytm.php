...
define('PAYTM_MERCHANT_KEY', 'xeWpzb333t7Kea8V'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'bYoqAe02921595593008'); //Change this constant's value with MID (Merchant ID) received from Paytm.
